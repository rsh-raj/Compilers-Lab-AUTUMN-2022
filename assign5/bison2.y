...
/* Defining attributes for non termianls  */ 
...
primary_expression: 
                    IDENTIFIER 
                        { yyreduce("primary_expression --> IDENTIFIER");
                            $$ = new Expression();
                            $$->symbol = $1;
                            $$->type = Expression::NONBOOLEAN;
                          }
                    | INTEGER_CONSTANT 
                        { yyreduce("primary_expression --> INTEGER_CONSTANT");
                            $$ = new Expression();
                    ...
                    | FLOATING_CONSTANT 
                        { 
                            ...
                            $$ = new Expression();
                            $$->symbol = gentemp(SymbolType::FLOAT, toString($1));
                            emit("=", $$->symbol->name, $1);
                         }
                    | CHARACTER_CONSTANT 
                        { 
...
argument_expression_list_opt:
                                ...
                                |
                                    { 
                                        yyinfo("argument_expression_list_opt => e");
                                        $$ = 0;
                                     }
                                ;
...
cast_expression:
                ...
                | '(' type_name ')' cast_expression /* can be ignored */
                    { 
...
init_declarator_list_opt:
                            ...
                            |
                                {
                                     yyinfo("init_declarator_list_opt => e"); 
                                }
                            ;
...
declaration_specifiers_opt:
                            ...
                            |
                                {
                                     yyinfo("declaration_specifiers_opt => e"); 
                                }
                            ;
...
specifier_qualifier_list_opt:
                                ...
                                | 
                                    { 
                                        yyinfo("specifier_qualifier_list_opt => e"); 
                                    }
                                ;
...
direct_declarator:
                    ...
                    | direct_declarator '(' change_scope parameter_type_list ')'
                        { 
                    ...
                    | direct_declarator '(' change_scope ')'
                        { 
                            yyinfo("direct_declarator => direct_declarator ( )"); 
...
type_qualifier_list_opt:
                        ...
                        |
                            { 
                                yyinfo("type_qualifier_list_opt => e"); 
                            }
                        ;
...
compound_statement:
                    '{' change_block change_scope block_item_list_opt '}'
                        { 
...
function_definition: // to prevent block change here which is there in the compound statement grammar rule
                    ...
                    declaration_specifiers declarator declaration_list_opt change_scope '{' block_item_list_opt '}'
                        { 
