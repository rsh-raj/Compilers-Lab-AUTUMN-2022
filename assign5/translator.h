...
class Symbol;
class Statement;
#define __int__size 4
#define __float__size 8
#define __char__size 1
#define __pointer__size 4
...
public:
    ...
    void printTable();                                       // prints the symbol table
...
public:
    ...
    void printQuad();                                    // prints the quad
};
